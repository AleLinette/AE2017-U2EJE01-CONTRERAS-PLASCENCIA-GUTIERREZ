...
public class Campaign implements Serializable {
    ...
    public Campaign(Integer campaignid, Date startdate, Date enddate, String message, boolean email, boolean cellphone, Object frecuency) {
        this.campaignid = campaignid;
    ...
    public Object getFrecuency() {
        return frecuency;
    }

    public void setFrecuency(Object frecuency) {
        this.frecuency = frecuency;
    }
    ...
    public String toString() {
        return "mx.edu.ittepic.aeu02eje01.entities.Campaign[ campaignid=" + campaignid + " ]";
    }
